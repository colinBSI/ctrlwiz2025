...
!define UNINSTALL_LOCATION "$COMMONFILES\${COMPANY}\Navisworks ${MAJOR_VERSION}\PlugIns\${SHORT_NAME}"
...
!define API_KEY "SOFTWARE\Autodesk\Navisworks API Runtime\${MAJOR_VERSION}"
